...
| --- | ---: | --- | --- | --- |
| H01 | 17568 | 86 This trick will change your life forever (Kaunas) | clickbait | a trick in which area? |
...
| H08 | 45270 | 45 She did X — what happens next will shock you — Read more | clickbait | did what in which area? |
...
| H13 | 29762 | 96 Top 7 paslaptys, kurias įmonės nenori, kad žinotumėte (London) | clickbait | kieno įmonės? |
...
| H19 | 445 | Top 7 secrets companies don't want you to know (London) | clickbait | which companies, what area? |
| H20 | 5242 | 45 Perėjimų gandai: jaunas puolėjas gali kainuoti rekordą | sports | puolėjas |

Topic groups: sport, finance, clickbait, tech

Same topic in different langauges will probably be classified in different topic groups since LDA does not understand the word to be able to cross reference it accrossdiffernet languages (e.g. H13, H19).
Filler phrases like "analitikų teigimu", "as markets react" can pull classification towards finance topic even though it's acctually about tech (e.g. H14)